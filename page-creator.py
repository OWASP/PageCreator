...
def walk_text(text):
    ...
    while idx < len(text):
        ...
        if text.lower().find(' ', p_ndx, index_l) == -1: # no spaces between the previous owasp or media and the pdf link
            ...
            idx = index_l + len(repl_pdf_link) + lentxt
        else: # https not where pdf
            idx = p_ndx + 1
...
def main():
    ...
    #content += "<p>The <a href='https://www.owasp.org/OWASP_Top_10-2017_(en).pdf.pdf' title='wikilink'>OWASP Top 10 - 2017</a> is now available.</p>"
    print(walk_text(content))
    #content += "<p>The <a href='https://www.owasp.org/0/1/a/c/images/OWASP_Top_10-2017_(en).pdf.pdf' title='wikilink'>OWASP Top 10 - 2017</a> is now available.</p>"
    #content += "<p>The <a href='Media:OWASP_Top_10-2017_(en).pdf.pdf' title='wikilink'>OWASP Top 10 - 2017</a> is now available.</p>"
